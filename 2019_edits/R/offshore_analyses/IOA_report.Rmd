...
year_plot_1
#ggsave(plot =  year_plot_1, here("figures", "yearly_catch.png"), dpi = 600)
...
year_plot_2
#ggsave(plot = year_plot_2, here("figures", "yearly_occurrence.png"), dpi = 600)
...
gridExtra::grid.arrange(
  grobs = list(year_plot_1, year_plot_2),
  nrow = 1)
```
...
szones_plot_1 
#ggsave(plot = szones_plot_1, here("figures", "statzones_catch.png"), dpi = 600)
...
szones_plot_2
#ggsave(plot = szones_plot_2, here("figures", "statzones_occurrence.png"), dpi = 600)
```
...
```{r}
gridExtra::grid.arrange(
  grobs = list(szones_plot_1, szones_plot_2),
  nrow = 1)
```
...
write_csv(seamap, here::here("data/offshore", "seamap_cpue_2019_analysis.csv"), 
          col_names = TRUE)
...
region_plot_1 
#ggsave(plot = region_plot_1, here("figures", "regions_catch.png"), dpi = 600)
```
...
region_plot_2
#ggsave(plot = region_plot_2, here("figures", "regions_occurrence.png"), dpi = 600)
...
```{r}
gridExtra::grid.arrange(
  grobs = list(region_plot_1, region_plot_2),
  nrow = 1)
```
...
gridExtra::grid.arrange(
  grobs = list(rs_plot_1 + theme(legend.position = "none"), rs_plot_2),
  nrow = 1)
...
```{r}
gridExtra::grid.arrange(
  grobs = list(season_plot_1 + theme(legend.position = "none"), season_plot_2),
  nrow = 1)
```
