#### SEAMAP JAGS Bernoulli & Gamma model code
library(tidyverse)
library(lattice)
library(R2jags)
source("~/Dropbox (The Craboratory)/The Craboratory/Kemberling/Rwork/Zuur_books/Zuuretal_2016_ZIM_AllData/MCMCSupportHighstatV4.R")

seamap <- read_csv("SEAMAP_model_ready.csv")
